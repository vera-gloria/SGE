...
require 'header.html';
?>
<div class="col-md-12 menu-button centro-block" >
    <a href="cursos.php"><button type="button" class="btn btn-primary btn-lg">Cursos</button></a>
    <a href="cursos.php"><button type="button" class="btn btn-primary btn-lg">Atividades</button></a>
    <a href="cursos.php"><button type="button" class="btn btn-primary btn-lg">Palestras</button></a>
</div>
