  	...
  	<div class="container">
        ...
        <div class="breadcrumb1">
            <ul>
                ...
                <li class="current-page"><a href="cursos.php">Cursos</a> with Curso_detail</li>
            </ul>
        </div>
  	</div>
  </div>
	...
	<div class="Cursos_box1">
	   <div class="container">
			...
			<div class="Cursos_box1-left">
                ...
                <!-- select-block -->
                <input type="submit" value="search" class="Curso-submit">		                            
            </form>
	       </div>
	       <div class="personBox">
		...
		<div class="col-md-9 detail">
			<img src="images/Curso.jpg" class="img-responsive" alt=""/>
			<h3>Curso Overview</h3>
