...
<div id="container">
	...
	<div id="boleto">
		...
		<table class="header" border=0 cellspacing="0" cellpadding="0">
			<tbody>
			<tr>
				<td width=150><IMG SRC="<?php echo $this->imagens; ?><?php base_url('images/logobb.jpg') ?>"></td>
				<td width=50>
		...
		<table cellspacing=0 cellpadding=0 width=666 border=0><TBODY><TR><TD width=665 align=right ><font style="font-size: 10px;">Autentica&ccedil;&atilde;o mec&acirc;nica - Ficha de Compensação</font></TD></tr></tbody></table>
		<div class="barcode">
