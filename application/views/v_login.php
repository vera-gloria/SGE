        ...
        <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
            <div class="panel panel-info" >
                    ...
                    <div style="padding-top:30px" class="panel-body" >
                        ...
                        <form id="loginform" class="form-horizontal" role="form" method="post" action="<?= base_url('index.php/login/logar') ?>">
...
<!--                                        <select name="tipo_usuario">
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                                        ...
                                        <input type="email" namo="email"class="form-control" name="username" value="" placeholder="E-mail">                                        
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 control">
                                        <div style="border-top: 1px solid#888; padding-top:15px; font-size:85%" >
                                            Não tem uma conta! 
                                        <a href="<?php echo base_url('participante/inserir/') ?>" onClick="$('#loginbox').hide(); $('#signupbox').show()">
                                            Crie uma agora.
                                        </a>
                                        </div>
                                    </div>
