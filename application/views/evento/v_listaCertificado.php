...
<div class="col-sm-12">
    ...
    <div class="btn alinhamento col-sm-3">
        <!--<a href="<?= base_url('usuario/cadastrar') ?>"><input type="submit" value="Salvar" class="usuariocadastro"></a>-->
        <a href="<?php echo base_url() . 'certificado/imprimirCertificado/' . $idevento; ?>"><input type="submit" value="Imprimir" class="botao"></a>
    </div>
