                ...
                <ul class="table-list">
                    <?php foreach ($evento as $e): ?>
                        <li class="clearfix">
                            ...
                            <div class="acao_col">
                                <!--<a href= "<?php echo base_url() . 'evento/inscrever/' . $e->idevento; ?>"><button type="button" class="btn btn-success"><i  class = "fa fa-pencil" > </i>&nbsp; Inscrever</button></a>--> 
                                <a href= "<?php echo base_url('evento/inscrever/') ?>"><button type="button" class="btn btn-success"><i  class = "fa fa-pencil" > </i>&nbsp; Inscrever</button></a> 
                            </div>
                        </li>
                    <?php endforeach ?>
                </ul>
