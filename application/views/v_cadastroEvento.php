            ...
            <div class="panel panel-info cadastroevento">
                ...
                <div class="panel-body" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="dtinicio" placeholder="" value="<?php echo set_value('dtinicio'); ?>"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="dttermino" placeholder="" value="<?php echo set_value('dttermino'); ?>"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="qtdevagas" placeholder="" value="<?php echo set_value('qtdevagas'); ?>"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="horario" placeholder="" value="<?php echo set_value('horario'); ?>"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="status" placeholder="" value="<?php echo set_value('status'); ?>"/>
